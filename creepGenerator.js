var creepGenerator = {
    ...
    run: function(creep) {
        ...
        console.log('creepGenerator300 being used');

        var numHarvesters0 = 2;
        var numUpgraders0 = 3;
        var numBuilders0 = 1;
        var numRepairers0 = 1;
        var numHarvesters = 3;
     ...
     /**   var numHarvesters2 = 3;
        ...
        if(builders.length < numBuilders) {
            var newName = Game.spawns['nuisance'].createCreep([WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, {role: 'builder'});
            console.log('Spawning new builder: ' + newName); 
        }
